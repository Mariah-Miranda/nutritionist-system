<?php
// appointments/today.php - Displays appointments for the current day
...
requireLogin();
// requireRole('Nutritionist'); // Example: Only nutritionists can view today's appointments
...
try {
    ...
    error_log("ERROR: Could not fetch today's appointments in today.php: " . $e->getMessage());
    echo "<p class='text-red-500'>Error fetching today's appointments. Please try again.</p>";
}
?>

<div class="bg-white rounded-lg shadow-md p-6">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Today's Appointments (<?php echo date('F j, Y'); ?>)</h2>
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    <?php foreach ($appointmentsToday as $appointment): ?>
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            <td class="py-3 px-6 text-left whitespace-nowrap"><?php echo htmlspecialchars(date('h:i A', strtotime($appointment['appointment_time']))); ?></td>
